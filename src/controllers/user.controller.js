...
const updateUserAvatar = asyncHandler(async (req,res) => {
    ...
    return res.status(200).json(new ApiResponse(200, user, "Avtart updated"))
...
const getUserChannelProfile = asyncHandler(async (req,res) => {
    ...
    return res.status(200).json(new ApiResponse(new ApiResponse(200, channel[0], "User channel data fetched successfully!!")));
});
...
export {resgisterUser, loginUser, logoutUser, refreshAccessToken, getCurrentUser, 
    updateAccountDetails, updateCoverImage, updateUserAvatar, changeCurrentPassword ,
